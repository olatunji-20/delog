<template>    
    <div class="w-[59.375rem] h-[auto] flex flex-row flex-nowrap justify-between md:h-[15.3125rem] md:w-[100%]">
        <div class="w-[16.875rem] relative h-[18.75rem] md:h-[14rem] md:w-[13.125rem]" v-for="blog in landingBlogs" :key="blog.id">
