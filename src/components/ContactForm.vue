<template>
  <div class="border-2 border-red-400 w-[100%] h-[auto]">
    <form class="px-2 py-8">
        ...
        <input class="border w-[100%] py-3 indent-4 mt-3 mb-8 rounded-md" placeholder="Last name" type="text" />
        <label class="font-bold block">Email</label>
        <input class="border w-[100%] py-3 indent-4 mt-3 mb-8 rounded-md" placeholder="you@company.com" type="email" />
