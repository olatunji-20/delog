<template>
    <div class="border-gray-300 w-[100%] h-[7rem] shadow-lg border-b-2 bg-[#edeff8] flex justify-between py-7 px-6 md:px-12">
        <router-link to="/">
        ...
        <div class="w-[auto] h-[auto] mt-4 hidden md:inline">
            <ul class="flex flex-row justify-between">
                ...
                <li class="group mx-6 relative top-0 duration-150 cursor-pointer hover:top-1"><span class="relative bottom-2">Services</span><i class="material-symbols-outlined">expand_more</i>
                ...
                <li class="mr-6 relative top-0 duration-150 cursor-pointer hover:top-1"><router-link to="/blog-post">Blog</router-link></li>
        ...
        <div class="w-[11.25rem] h-[3.125rem] hidden md:flex justify-between ">
            <div class="border border-[#0063f7] rounded-md px-6 py-3 text-[#0063f7] cursor-pointer duration-200 hover:bg-[#0063f7] hover:text-white">
