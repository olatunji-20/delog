<template>
  ...
  <div class="w-[100%] h-[auto] py-12 px-4 md:p-12">
    ...
    <p class="text-center pt-4 md:px-80" data-aos="slide-left">
    ...
    <hr class="border border-gray-300 my-8 mx-[auto] w-[80%]" />

    <h1 class="font-bold text-3xl text-center mt-20" data-aos="fade-in">
      MEET OUR TEAM
    </h1>
    <p class="text-center pt-4 md:px-64" data-aos="slide-right">
    ...
    <div
      class="w-[100%] h-[auto] mx-auto mt-8 overflow-auto md:mt-12 md:p-2 md:w-[95%]"
    >
  ...
  <!-- COMPLETED SECTION -->
  <div
    class="w-[100%] h-[auto] bg-[#d8ddef] mb-8 flex flex-col flex-wrap md:flex-row justify-center"
    data-aos="slide-up"
  >
    <div
      class="border-gray-400 w-[100%] md:border-r h-[auto] text-center py-12 md:w-[21.875rem]"
    >
    ...
    <div
      class="border-gray-400 w-[100%] h-[auto] text-center py-12 md:w-[21.875rem]"
    >
